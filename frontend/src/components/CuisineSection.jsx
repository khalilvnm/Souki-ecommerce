    ...
    <div className='py-10'>
      ...
      <div>
        <Carousel responsive={productResponsive} className="z-0">
          {cuisineProducts.slice(0, 5).map((product, index) => (
        ...
        <div className="flex justify-end mt-4">
          <Link to="/cuisine" className="bg-third text-fifth font-semibold py-2 px-6 rounded-full hover:bg-second transition-all duration-300 shadow-md">
            Voir tout
          </Link>
        </div>
      </div>
