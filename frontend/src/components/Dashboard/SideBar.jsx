      ...
      <div className='links flex flex-col'>
        ...
        {isAdmin && (
          <>
            ...
            <NavLink to={"/dashboard/seller-applications"} className="flex items-center gap-4 py-3 w-full border-b border-gray-300 px-[3vw]">
              <FaStore className="text-2xl text-gray-800 md:text-[22px]" />
              <p className="text-[15px] text-gray-700 font-medium hidden md:block">Seller Applications</p>
            </NavLink>

            <NavLink to={"/dashboard/messages"} className="flex items-center gap-4 py-3 w-full border-b border-gray-300 px-[3vw]">
